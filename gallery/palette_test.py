...
narrow = [("ember", "ember"), ("dusk", "dusk"),
          ("rose", "rose"), ("sienna", "sienna")]
broad  = [("moss", "moss"), ("cobalt", "cobalt"),
          ("lavender", "lavender")]
mono1  = [("blues", "blues"), ("greens", "greens"),
          ("purples", "purples")]
mono2  = [("greys", "greys"), ("reds", "reds"),
          ("oranges", "oranges")]
multi  = [("GnBu", "GnBu"), ("YlGnBu", "YlGnBu"),
          ("RdPu", "RdPu")]
diverg  = [("RdBu", "RdBu"), ("PuGn", "PuGn"),
           ("BrTe", "BrTe")]
diverg2 = [("GdBu", "GdBu"), ("MgGn", "MgGn"),
           ("YlPu", "YlPu")]
...
def make_swatch(key):
    ...
    return (
        ...
        .encode(
            ...
            color=alt.Color("c:N",
                            scale=alt.Scale(domain=p, range=p), legend=None),
        )
...
def make_de_overlay(key_sat2, key_oklab):
    ...
    return (
        ...
        .encode(
            ...
            y=alt.Y("dE:Q", title="ΔE",
                    scale=alt.Scale(domain=[lo, hi])),
            color=alt.Color("series:N",
                            scale=alt.Scale(domain=["sat2", "oklab"],
                                            range=["#999999", "#E45756"]),
                            legend=None),
        )
...
def make_row(group, title=""):
    ...
    return (
        alt.hconcat(*cols, spacing=10, title=title)
        .resolve_scale(color="independent")
    )
